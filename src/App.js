      ...
      <div>
        <Router>
          ...
          <Switch>
            ...
            <Route exact path='/health'><News key="health" pageSize={5} country="in" category="" /></Route>
            <Route exact path='/science'><News key="science" pageSize={5} country="in" category="science" /></Route>
            <Route exact path='/sports'><News key="sports" pageSize={5} country="in" category="sportstechnology" /></Route>
